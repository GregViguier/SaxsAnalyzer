...
data = hdfReader.load_image_at_index(
    r'/home/gregory/Dropbox/elisabeth_0044_2013-10-05_04-10-19.nxs', 'buffer_0044', 5)
...
q, I, Sigma = ai.integrate1d(
    data, 1448, unit="q_nm^-1", error_model="poisson", polarization_factor=1.0, method="numpy")
